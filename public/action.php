...
<table style="width: 100%;">';
    ...
    if (!empty($_POST['utm_content'])) {
        $html .= ' <tr style="background-color: #f8f8f8;"> <td style="padding: 10px; border: #e9e9e9 1px solid;"> utm_content:</td>   <td style="padding: 10px; border: #e9e9e9 1px solid;">' . $_POST['utm_content'] . '</b></td>';
    }
